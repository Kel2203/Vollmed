...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosAgendamentoConsultas> dadosAgendamentoConsultaJson;

    @Autowired
    private JacksonTester<DadosDetalhamentoConsultas> dadosDetalhamentoConsultaJson;
